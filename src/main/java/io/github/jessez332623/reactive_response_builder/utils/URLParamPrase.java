package io.github.jessez332623.reactive_response_builder.utils;
...
final public class URLParamPrase
{
    ...
    prasePathVariables(final @NotNull ServerRequest request)
    {
        return
        Mono.fromCallable(request::pathVariables);
    }
