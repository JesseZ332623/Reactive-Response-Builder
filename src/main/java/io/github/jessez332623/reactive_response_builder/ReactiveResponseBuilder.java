package io.github.jessez332623.reactive_response_builder;

import io.github.jessez332623.reactive_response_builder.pojo.*;
...
/** 基于 WebFlux 的 HTTP 通用响应构建器。*/
@Slf4j
@NoArgsConstructor(access = AccessLevel.PRIVATE)
final public class ReactiveResponseBuilder
{
    /**
     * 响应体静态模板类。
     *
     ...
     * @return 构造好地响应体
     */
    private static <T> @NotNull APIResponse<T>
    produceBody(
     ...
     * <p>用例如下所式：</p>
     * <pre><code>
     * ReactiveResponseBuilder builder;
     * builder.build(
     *     OK, data,
     *     headers -> {
     ...
     * @return 构造好地响应体 Mono
     */
    public static @NotNull Mono<ServerResponse>
    build(
